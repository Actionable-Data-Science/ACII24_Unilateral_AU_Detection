...
class Logger:
    ...
    def load_cpk(checkpoint_path, generator=None, discriminator=None, kp_detector=None,
                 optimizer_generator=None, optimizer_discriminator=None, optimizer_kp_detector=None,avd_network=None):
    ...
    @staticmethod
    def load_cpk_bg(checkpoint_path, generator=None, kp_detector=None, bg_predictor=None,
                 optimizer=None):
        ...
        if bg_predictor is not None:
            ckp_bg_predictor = collections.OrderedDict((k.replace('.module.','.'),v) for k,v in checkpoint['bg_predictor'].items())
            bg_predictor.load_state_dict(ckp_bg_predictor)
        
        if optimizer is not None:
            ckp_optimizer_generator = collections.OrderedDict((k.replace('.module.','.'),v) for k,v in checkpoint['optimizer'].items())
